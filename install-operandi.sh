...
LOG_INFO="\e[0;34mINFO:\e[0m"
LOG_ERROR="\e[1;31mERROR:\e[0m"
LOG_WARNING="\e[0;34mWARNING:\e[0m"
LOG_SUCCESS="\e[0;35mSUCCESS:\e[0m"
...
dconf write "$profile_path"cursor-foreground-color "'#ffffff'"
dconf write "$profile_path"cursor-background-color "'#000000'"
...
dconf write "$profile_path"palette "$(cat $PWD/palette-operandi)"

printf "\n"

alert -s "The theme is now installed, restart the terminal!"
